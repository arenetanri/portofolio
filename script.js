...
const projects = {
squishy: {
 title:"Squishy Squeezer", sub:"Automated Retrieval Claw · UBC APSC 101 · Jan–Feb 2026", hero:"squishy-squeezer-photo.jpg",
 ...
 <div class="slide-deck" data-slideshow>
   <img class="active" src="squishy-slide-wdm.png" alt="Weighted decision matrix slide">
   <img src="squishy-slide-scoring.png" alt="Concept scoring slide">
   <img src="squishy-slide-anchor.png" alt="Anchor placement investigation slide">
   <img src="squishy-slide-filtering.png" alt="Sensor filtering investigation slide">
   <img src="squishy-slide-drawings.png" alt="Engineering drawings slide">
   <img src="squishy-slide-competition.png" alt="Competition reflection slide">
...
rwh: {
 title:"Rainwater Harvesting System", sub:"Off-grid potable-water system · UBC APSC 101 · Mar–Apr 2026", hero:"rwh-hero.png",
 ...
 <div class="case-grid"><img src="rwh-results.png"><img src="rwh-hero.png"></div>
...
chair: {
 title:"Cardboard Chair", sub:"Disaster-relief product design · UBC APSC 100 · Sep–Oct 2025", hero:"cardboard-chair-poster.jpg",
...
pen: {
 title:"Pen Planter", sub:"Assistive gardening design · UBC APSC 100 · Nov 2025", hero:"pen-planter-hero.jpg",
 ...
 <img class="wide-detail" src="seed-dispensing-shovel-alexandrene.jpg" alt="Alexandrene's Seed Dispensing Shovel SolidWorks model">
 ...
 <div class="case-grid"><img src="pen-planter-cad-final.png" alt="Final Pen Planter CAD"><img src="pen-planter-prototype-final.jpg" alt="Final Pen Planter physical prototype"></div>
...
parking: {
 title:"Arduino Parking System", sub:"Solo school project · Early 2025", hero:"parking-digital-model.png",
 ...
 <div class="case-grid"><img src="parking-model-1.png"><img src="parking-hardware.png"></div>
...
bike: {
 title:"Vancouver Bike-Lane Proposal", sub:"Systems & sustainability decision-making · UBC APSC 100 · 2025", hero:"bike-lane-final.png",
...
mining: {
 title:"Copper Mine Feasibility Assessment", sub:"Sustainability & systems analysis · UBC APSC 101 · 2026", hero:"mining-final.png",
...
watch: {
 title:"Mechanical Watch Build", sub:"Personal project · 2026", hero:"watch-finished.jpeg",
 ...
 <div class="watch-grid">
   <figure><img src="watch-build-workbench.jpeg" alt="Watch-building workbench with tools and components"><figcaption>Assembly setup and tools</figcaption></figure>
   <figure><img src="watch-finished.jpeg" alt="Completed automatic mechanical wristwatch"><figcaption>Completed watch</figcaption></figure>
 </div>
 <video class="build-video" controls muted playsinline preload="metadata" poster="watch-build-workbench.jpeg">
   <source src="watch-build-preview.mp4" type="video/mp4">
 </video>
...
keyboard: {
 title:"Custom Mechanical Keyboard", sub:"Personal build · 2025", hero:"keyboard-finished-horizontal.jpeg",
 ...
 <div class="slideshow keyboard-slideshow" data-slideshow>
   <img class="active" src="keyboard-finished-horizontal.jpeg" alt="Finished custom mechanical keyboard">
   <img src="keyboard-build-process.jpeg" alt="Mechanical keyboard disassembled during the build">
   <img src="keyboard-switch-lube.jpeg" alt="Mechanical switches sorted during keyboard customization">
   <img src="keyboard-switch-closeup.jpeg" alt="Close-up of keyboard switch components">
   <div class="slide-dots"></div>
 </div>
...
pc: {
 title:"Custom PC Build", sub:"Personal hardware build · 2025", hero:"pc-lit.png",
 ...
 <div class="case-grid"><img src="pc-components.png"><img src="pc-open-case.png"></div>
 ...
 <img class="case-hero" src="pc-desk.png" alt="Completed PC setup">`
}
};
